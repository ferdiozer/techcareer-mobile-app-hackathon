...
export const getGroupedConversation = ({ conversations }) => {
  const conversationGroupedByDate = _.groupBy(Object.values(conversations), (message) =>
...
export const getGroupedNotifications = ({ notifications }) => {
  const notificationGroupedByDate = _.groupBy(Object.values(notifications), (notification) =>
